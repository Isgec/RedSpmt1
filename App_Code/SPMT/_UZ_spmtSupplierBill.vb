...
Namespace SIS.SPMT
  Partial Public Class spmtSupplierBill
    ...
    Public Shared Function GetBPFromERP(ByVal BPID As String) As SIS.SPMT.spmtBusinessPartner
      ...
      Sql &= "  from ttccom100700 as suh                                       "
      Sql &= "  left outer join ttccom130700 as adh on suh.t_cadr = adh.t_cadr "
      Sql &= "  left outer join ttccom140700 as cnh on suh.t_ccnt = cnh.t_ccnt "
