...
Namespace SIS.VR
  Partial Public Class vrPaymentProcess
    ...
    End Function
      ...
      Sql = Sql & "from ttfacp100700 as ir "
      Sql = Sql & "     inner join ttfcmg101700 as pb on (ir.t_ctyp = pb.t_ttyp and ir.t_cinv = pb.t_ninv)  "
      Sql = Sql & "     inner join ttfcmg100700 as cq on pb.t_btno = cq.t_pbtn "
      Sql = Sql & "     inner join ttfcmg109700 as bt on pb.t_btno = bt.t_btno "
