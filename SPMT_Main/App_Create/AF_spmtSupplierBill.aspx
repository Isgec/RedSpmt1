<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="AF_spmtSupplierBill.aspx.vb" Inherits="AF_spmtSupplierBill" title="Add: Supplier Bill" %>
...
<div id="div2" class="caption">
    <asp:Label ID="LabelspmtSupplierBill" runat="server" Text="&nbsp;Add: Supplier Bill"></asp:Label>
</div>
...
<asp:FormView ID="FVspmtSupplierBill"
  ...
  <InsertItemTemplate>
    ...
    <asp:Label ID="L_ErrMsgspmtSupplierBill" runat="server" ForeColor="Red" Font-Bold="true" Text=""></asp:Label>
...
<asp:ObjectDataSource 
  ...
  InsertMethod="UZ_spmtSupplierBillInsert"
