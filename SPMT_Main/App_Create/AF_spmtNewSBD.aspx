<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="AF_spmtNewSBD.aspx.vb" Inherits="AF_spmtNewSBD" title="Add: *Supplier Bill Items" %>
...
<div id="div2" class="caption">
    <asp:Label ID="LabelspmtNewSBD" runat="server" Text="&nbsp;Add: *Supplier Bill Items"></asp:Label>
</div>
...
<asp:FormView ID="FVspmtNewSBD"
  ...
  <InsertItemTemplate>
    ...
    <asp:Label ID="L_ErrMsgspmtNewSBD" runat="server" ForeColor="Red" Font-Bold="true" Text=""></asp:Label>
      ...
      <tr>
        ...
        <td>
          <asp:TextBox
            ...
            ValidationGroup = "spmtNewSBD"
            onblur= "script_spmtNewSBD.validate_IRNo(this);"
            Runat="Server" />
          ...
          <AJX:AutoCompleteExtender
            ...
            OnClientItemSelected="script_spmtNewSBD.ACEIRNo_Selected"
            OnClientPopulating="script_spmtNewSBD.ACEIRNo_Populating"
            OnClientPopulated="script_spmtNewSBD.ACEIRNo_Populated"
...
<asp:ObjectDataSource 
  ...
  InsertMethod="UZ_spmtNewSBDInsert"
