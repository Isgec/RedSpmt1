...
Public Class RPT_spmtPaymentAdvice
  ...
  Public Function ProcessReport() As String
    ...
    Print("<td style=""font-size:12px;font-weight:bold;width:25%;text-align:left;vertical-align:top"">&nbsp;</td>")
    Print("<td style=""font-size:12px;font-weight:bold;width:25%;text-align:left;vertical-align:top"">&nbsp;</td>")
    'Print("<td style=""font-size:12px;font-weight:bold;width:25%;text-align:left;vertical-align:top"">(HOD)</td>")
    Print("<td style=""font-size:12px;font-weight:bold;width:25%;text-align:left;vertical-align:top"">&nbsp;</td>")
    Print("<td style=""font-size:12px;font-weight:bold;width:25%;text-align:right;vertical-align:top""></td>")
    Print("</tr>")
    Print("</table>")
    Return Report
  End Function
